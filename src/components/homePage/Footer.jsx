        ...
        <div className="flex flex-col md:flex-row justify-between gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-300">
              <li className="hover:text-[#137fec] cursor-pointer transition" onClick={handleScroll("features")}>Features</li>
              <li className="hover:text-[#137fec] cursor-pointer transition" onClick={handleScroll("about")}>About Us</li>
              <li className="hover:text-[#137fec] cursor-pointer transition" onClick={handleScroll("join")}>Join Us</li>
            </ul>
          </div>
        </div>
